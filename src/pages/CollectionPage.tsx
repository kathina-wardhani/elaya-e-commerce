...
import { getCollectionBySlug, featuredProducts } from "@/data/mock";
...
const collectionImages: Record<string, string> = {
  "sparkle-and-shine": editorialParty,
  "keep-it-chill": editorialCasual,
  "power-dressing": editorialOffice,
  "make-an-entrance": editorialGala,
};
...
const CollectionPage = () => {
  ...
  const image = slug ? collectionImages[slug] : undefined;
    ...
    <div className="min-h-screen bg-background">
      ...
      <main>
        ...
        <section className="relative h-[50vh] overflow-hidden">
          {image && <img src={image} alt={collection.title} className="h-full w-full object-cover" />}
